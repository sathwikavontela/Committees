...
const CentralAuthorityProfileCard = ({ Data }) => {
  return (
    <div className="flex justify-center mt-8 md:mt-10">
      <div className="max-w-xs md:max-w-lg">
        <div className="flex flex-row items-center w-fit lg:px-8 md:px-0 sm:px-8 bg-white border border-gray-200 rounded-lg shadow-md">
          <img
