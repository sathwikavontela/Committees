          ...
          <div className="mt-8 h-fit  md:relative z-[-1] md:left-[21%]  md:top-0 rounded-md pb-4 lg:w-[90%] lg:left-[25.5%] md:w-[80%] sm:w-[100%] sm:mt-20 sm:ml-[-3%] sm:mb-10  md:overflow-y-hidden">
            ...
            <div className="mt-8 border border-[#45d9b9] rounded-md pb-4 lg:w-[80%] sm:w-[90%] sm:mx-8 lg:mx-0">
              ...
              <div className="flex flex-wrap justify-center items-center px-4">
                ...
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[7]} />
                </div>
              </div>
            </div>
            <div className="mt-8 border border-[#eb692d] rounded-md pb-4 lg:w-[80%] sm:w-[90%] sm:mx-8 lg:mx-0">
              ...
              <div className="flex flex-wrap justify-center items-center px-4">
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[8]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[9]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[10]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[11]} />
                </div>
              </div>
            </div>
            <div className="mt-8 border border-[#bddc3f] rounded-md pb-4 lg:w-[80%] sm:w-[90%] sm:mx-8 lg:mx-0">
              ...
              <div className="flex flex-wrap justify-center items-center px-4">
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[12]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[13]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[14]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[15]} />
                </div>
              </div>
            </div>
            <div className="mt-8 border border-[#e33244] rounded-md pb-4 lg:w-[80%] sm:w-[90%] sm:mx-8 lg:mx-0">
              ...
              <div className="flex flex-wrap justify-center items-center px-4">
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[16]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[17]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[18]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[19]} />
                </div>
              </div>
            </div>
            <div className="mt-8 border border-[#1d4872] rounded-md pb-4 lg:w-[80%] sm:w-[90%] sm:mx-8 lg:mx-0">
              ...
              <div className="flex flex-wrap justify-center items-center px-4">
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[20]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[21]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[22]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[23]} />
                </div>
              </div>
            </div>
            <div className="mt-8 border border-[#e81791] rounded-md pb-4 lg:w-[80%] sm:w-[90%] sm:mx-8 lg:mx-0 mb-4">
              ...
              <div className="flex flex-wrap justify-center items-center px-4">
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[24]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[25]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[26]} />
                </div>
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 px-2 mb-1">
                  <CentralAuthorityProfileCard Data={students[27]} />
                </div>
              </div>
            </div>
          </div>
